...
3. **Usability:** adjust the panel width so the OpenCode prompt is readable. Do not leave a narrow sliver and call the arrangement complete. Confirm Korean/non-ASCII text where present. Do not interact with unrelated apps or security popups.
